...
class Login extends CI_Controller {
		...
		if($this->form_validation->run() == false){
			...
			if(isset($post['login'])){
				...
				if($query->num_rows() > 0){
					...
					echo "<script> alert('selamat datang $row->user_nama');
	...
	public function tambah()
	{
		...
		$this->form_validation->set_rules('username','Username','required|trim|max_length[15]|is_unique[web_user.user_username]',[
